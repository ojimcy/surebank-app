...
function PackageList() {
  ...
  const [activeTab, setActiveTab] = useState<'all' | 'packages' | 'types'>(
    'all'
  );
  ...
  return (
    <div className="space-y-6 pb-20 relative">
      ...
      {/* Combined View - Both Packages and Types */}
      {!loading && !error && packages.length > 0 && activeTab === 'all' && (
        <div className="space-y-6">
          {/* User's Packages Section */}
          <div>
            <h2 className="text-lg font-bold text-gray-900 mb-3">
              Your Packages
            </h2>
                          ...
                          {pkg.productImage ? (
                            <img
                              ...
                              onError={(e) => {
                                ...
                                imgEl.onerror = null;
                                imgEl.src =
                                  pkgTypeIcons[pkg.type] || DefaultIcon;
